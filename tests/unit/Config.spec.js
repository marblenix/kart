...
describe('Config', () => {
  ...
  it('returns a list of items for a given distance', () => {
    const wrapper = shallowMount(Config, { data: testItems });
    expect(wrapper.vm.getItemsForDistance(0)).toBe(defaults[0].items);
    expect(wrapper.vm.getItemsForDistance(100)).toBe(defaults[0].items);
    expect(wrapper.vm.getItemsForDistance(400)).toBe(defaults[0].items);
    expect(wrapper.vm.getItemsForDistance(401)).toBe(defaults[1].items);
    expect(wrapper.vm.getItemsForDistance(999)).toBe(defaults[1].items);
    expect(wrapper.vm.getItemsForDistance(1000)).toBe(defaults[1].items);
    expect(wrapper.vm.getItemsForDistance(1001)).toStrictEqual([]);
  });
